...
describe("Integrator", () => {
  ...
  const testBaseUrl: string = "./test/03_integrator";
  ...
  describe("Integrator Config is used", () => {
    ...
    context(
      "IHtmlComponentIntegration with pathToComponent and selector",
      () => {
        const config: ISearchIntegratorConfig = {
          inputDirectories: [
            {
    ...
    context(
      "IHtmlComponentIntegration with pathToComponent and placement",
      () => {
        it("should check if an HTML file exists and contains the specified component at the specified place", function () {
    ...
    context(
      "IStylesheetIntegration with pathToStylesheet",
      () => {
        console.log("");
      }
    );
    ...
    context(
        "IStylesheetIntegration with pathToStylesheet and selector",
        () => {
          console.log("");
        }
    );
    ...
    context(
        "IStylesheetIntegration with pathToStylesheet and placement",
        () => {
          console.log("");
        }
    );
